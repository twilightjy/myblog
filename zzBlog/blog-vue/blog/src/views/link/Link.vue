<template>
  <div>
    ...
    <v-card class="blog-container">
      ...
      <blockquote>
        <div>格式参考如下~</div>
        <div>名称：夕阳皎月的个人博客</div>
        <div>简介：When KobeBryant died,a piece of me died.</div>
        <div>头像：http://www.static.twilightjy.com/avatar/myavatar.jpg</div>
      </blockquote>
      <div class="mt-5 mb-5">
        需要交换友链的可在下方留言💖
      </div>
...
.link-banner {
  background: url(http://www.static.twilightjy.com/background/back5.png) center center /
    cover no-repeat;
