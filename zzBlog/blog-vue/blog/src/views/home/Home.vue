      ...
      <div class="banner-container">
        ...
        <div class="blog-contact">
          <a
            ...
            target="_blank"
            href="http://wpa.qq.com/msgrd?v=3&uin=1362410372&site=qq&menu=yes"
          />
          <a
            target="_blank"
            href="https://github.com/twilightjy"
            class="ml-5 mr-5 iconfont icongithub"
          />
          <a
            target="_blank"
            href="https://gitee.com/twilightjy"
...
export default {
  ...
  methods: {
    ...
    runTime() {
      var timeold =
        new Date().getTime() - new Date("April 28,2021").getTime();
...
.home-banner {
  ...
  /*width:100%;			//大小设置为100%*/
  /*height:100%;			//大小设置为100%*/
  background: #49b1f5 url("http://www.static.twilightjy.com/background/back8.png") no-repeat fixed center center;
